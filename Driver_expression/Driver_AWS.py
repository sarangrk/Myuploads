...
inputfilename='/home/sarang/Driver_expression/www/default_video.mp4'
print("hello")
outputfilename='/srv/shiny-server/Driver_expression/www/kaptan.mp4'
#outputfilename='/home/sarang/Driver_expression/testPrincy_3nd.mp4'
def performdetection(inputfilename, outputfilename):
  #shape_predictor= '/home/sarang/Driver_expression/shape_predictor_68_face_landmarks.dat'
  #shape_predictor = os.path.join(os.path.expanduser('~'),'Driver_expression','shape_predictor_68_face_landmarks.dat')
  shape_predictor = ('/srv/shiny-server/Driver_expression/shape_predictor_68_face_landmarks.dat')
  # initialize dlib's face detector (HOG-based) and then create
  # the facial landmark predictor
  #print("[INFO] loading facial landmark predictor...")
  detector = dlib.get_frontal_face_detector()
  predictor = dlib.shape_predictor(shape_predictor)
  #outputFile = 'DriverExpression.m4v'
  #vs = VideoStream(src=0).start()
  #vs = cv2.VideoCapture('default_video.mp4')
  vs = cv2.VideoCapture(inputfilename)
  #fourcc = cv2.VideoWriter_fourcc(*'MJPG')
  #fourcc = cv2.VideoWriter_fourcc('m', 'p', '4', 'v')
  width = vs.get(cv2.CAP_PROP_FRAME_WIDTH)
  height = vs.get(cv2.CAP_PROP_FRAME_HEIGHT)
  fourcc = cv2.VideoWriter_fourcc('m', 'p', '4', 'v')
  out = cv2.VideoWriter(outputfilename,fourcc, 20.0, (int(width),int(height)))
  #writer = cv2.VideoWriter('output1.m4v',-1, 20.0, (640,480))
          ...
          for rect in rects:
                  ...
                  for (x, y) in shape:
                          ...
                          try:
                            ...
                            print('Error aya babu',type(frame))
                            #continue
                            break
                          #break
                          ...
                          if diff_chx<10 and diff_chy<10:
                                  ...
                                  if diff_smile>10 and diff_smile<52 and j!=1:
