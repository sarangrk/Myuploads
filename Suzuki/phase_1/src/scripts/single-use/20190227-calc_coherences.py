...
IN_FILE_PATH = path.join(PRJ_ROOT, 'data/interim/noise_records_rev.csv')
OUT_FILE_PATH = path.join(PRJ_ROOT, 'data/interim/noise_records_rev_lda_coherences_2.pkl')

# n_topics = [10, 15, 20, 30, 40, 50, 60, 70, 80, 90, 100, 150, 200]
n_topics = list(range(50, 80))
n_folds = 5
seed = 0
