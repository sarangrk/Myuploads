  ...
  fluidPage(
    ...
    fluidRow(
      ...
      column(3,
             ...
             textInput('Model Training', "Model Training", value = "Using Keras and Dnn", placeholder = "Keras and Dnn"))
      ...
      wellPanel(
        tags$ul (type="square", style="font-size:110%",
                 ...
                 tags$li (tags$b("Training Model"), 
                          tags$ul (type="circle", style="font-size:110%",tags$li ("Trainig Model will take the input dataset files in the training set and train model")))
