...
def Hand_Gesture(inputfilename, outputfilename):
    ...
    cam = cv2.VideoCapture(inputfilename)
    ...
    while(True):
        ...
        try:  #an error comes if it does not find anything in window as it cannot find contour of max area
            ...
            roi=frame[200:550, 200:550]
            
            
            cv2.rectangle(frame,(200,200),(700,700),(0,0,255),0)    
        ...
        #code for finding no. of defects due to fingers
            ...
            if l==1:
                if areacnt<2000:
                    ...
                    #elif arearatio<20:
                        #cv2.putTet(frame,'Peace',(0,50), font, 2, (0,0,255), 3, cv2.LINE_AA)
